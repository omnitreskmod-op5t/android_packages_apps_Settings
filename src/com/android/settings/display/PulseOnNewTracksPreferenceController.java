...
import static android.provider.Settings.System.OMNI_PULSE_ON_NEW_TRACKS;
...
public class PulseOnNewTracksPreferenceController extends
    ...
    public boolean isChecked() {
         return Settings.System.getIntForUser(mContext.getContentResolver(),
                OMNI_PULSE_ON_NEW_TRACKS, 1,
                MY_USER) == 1;
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        Settings.System.putInt(mContext.getContentResolver(), OMNI_PULSE_ON_NEW_TRACKS, isChecked ? ON : OFF);
        return true;
    }
